    ...
    <Layout>
      <section className="relative h-[50vh] min-h-[400px] w-full overflow-hidden bg-[#1e3a8a]">
        ...
        <div className="relative z-10 h-full flex flex-col items-center justify-center text-center px-4 max-w-5xl mx-auto">
          ...
          <p className="text-xl md:text-2xl text-[#c5a059] font-semibold mb-6 tracking-wide">GAVER TIL MENIGHEDEN</p>
          <SectionDivider />
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-gradient-to-br from-white to-[#f8f6f1] rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all border-2 border-[#c5a059]/20 hover:border-[#c5a059]/40 group">
              ...
              <h3 className="font-serif text-2xl md:text-3xl font-bold text-[#1e3a8a] mb-4 text-center">Kollekt ved messen</h3>
            ...
            <div className="bg-gradient-to-br from-white to-[#f8f6f1] rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all border-2 border-[#c5a059]/20 hover:border-[#c5a059]/40 group">
              ...
              <h3 className="font-serif text-2xl md:text-3xl font-bold text-[#1e3a8a] mb-6 text-center">Bankoverførsel</h3>
            ...
            <div className="bg-gradient-to-br from-white to-[#f8f6f1] rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all border-2 border-[#c5a059]/20 hover:border-[#c5a059]/40 group md:col-span-2 lg:col-span-1">
              ...
              <h3 className="font-serif text-2xl md:text-3xl font-bold text-[#1e3a8a] mb-6 text-center">MobilePay</h3>
              <div className="bg-white rounded-xl p-6 border-2 border-[#c5a059]/20 shadow-sm">
                <div className="text-center">
                  ...
                  <p className="font-mono text-4xl md:text-5xl font-bold text-[#c5a059] tracking-wider">53 77 35</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="py-24 bg-gradient-to-b from-white to-[#f8f6f1] relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="bg-white rounded-2xl p-8 shadow-lg border border-slate-200 text-center hover:shadow-xl transition-shadow">
            ...
            <h3 className="font-serif text-2xl font-bold text-[#1e3a8a] mb-4">VKort - Kontaktoplysninger</h3>
            ...
            <a href="/Sognekontoret.vcf" download className="inline-flex items-center gap-2 px-6 py-3 bg-[#1e3a8a] text-white font-semibold rounded-lg hover:bg-[#2563eb] transition-colors shadow-md hover:shadow-lg">
      ...
      <section className="py-24 bg-[#1e3a8a] text-white relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          ...
          <div className="mt-12 pt-8 border-t border-white/20">
            <p className="text-[#c5a059] font-semibold text-lg italic">Gud velsigne dig for din generøsitet</p>
          </div>
        </div>
      </section>
    </Layout>
