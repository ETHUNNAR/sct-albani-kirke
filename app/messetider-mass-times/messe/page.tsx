    ...
    <Layout>
      <section className="relative min-h-[70vh] w-full overflow-hidden">
        <div className="absolute inset-0 z-0">
          ...
          />
          <div className="absolute inset-0 bg-gradient-to-b from-[#0a1628]/80 via-navy/60 to-navy/95" />
          <div
        ...
        <div className="relative z-10 h-full flex flex-col items-center justify-center text-center px-4 py-32 max-w-5xl mx-auto">
          <div className="mb-8">
            <svg className="w-16 h-16 text-gold" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1}>
              <path strokeLinecap="round" strokeLinejoin="round" d="M12 3v18M3 12h18" />
            </svg>
          </div>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="prose prose-lg max-w-none">
            <p className="text-slate-700 text-lg leading-relaxed mb-6">
              Ordet &ldquo;liturgi&rdquo; stammer fra græsk og betyder <em className="text-navy font-medium">&ldquo;offentlig tjeneste udført på offentlighedens vegne&rdquo;</em>.
            ...
            <div className="bg-[#fdfbf7] rounded-xl p-6 my-8 border-l-4 border-navy">
              ...
              <p className="text-navy font-medium"><strong>At gå til messe ER:</strong> at leve med i en begivenhed - den største i menneskehedens historie.</p>
            </div>
      ...
      <section className="py-12 bg-[#fdfbf7]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="relative bg-white rounded-2xl shadow-lg border border-slate-100 p-8 md:p-12 overflow-hidden">
            <div className="absolute top-0 right-0 w-32 h-32 bg-gradient-to-bl from-navy/5 to-transparent" />
            <div className="absolute bottom-0 left-0 w-24 h-24 bg-gradient-to-tr from-gold/10 to-transparent" />

            <div className="relative flex flex-col md:flex-row items-center gap-8">
              <div className="flex-shrink-0">
                <div className="w-20 h-20 rounded-2xl bg-gradient-to-br from-navy to-[#2a5aa8] flex items-center justify-center shadow-lg">
              ...
              <div className="flex-shrink-0">
                <a
                  ...
                  download
                  className="inline-flex items-center gap-3 px-6 py-4 bg-gold text-white rounded-xl font-medium hover:bg-[#b08c4a] transition-colors shadow-lg shadow-gold/20 group"
                >
      ...
      <section className="py-24 bg-gradient-to-b from-[#fdfbf7] to-white relative overflow-hidden">
        <div className="absolute top-0 right-0 w-96 h-96 bg-navy/5 rounded-full blur-3xl" />
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="relative">
            <div className="absolute left-1/2 top-0 bottom-0 w-px bg-gradient-to-b from-gold via-navy to-gold hidden md:block" />
            ...
            <div className="space-y-8 md:space-y-0">
              {massStructure.map((step, index) => (
                ...
                >
                  <div className={`flex-1 ${index % 2 === 0 ? 'md:text-right md:pr-16' : 'md:text-left md:pl-16'}`}>
                    <div className={`bg-white p-8 rounded-2xl shadow-lg border border-slate-100 hover:shadow-xl transition-shadow ${
                      ...
                      <div className={`flex items-center gap-4 mb-4 ${index % 2 === 0 ? 'md:flex-row-reverse' : ''}`}>
                        ...
                        <div>
                          <span className="text-gold text-sm font-medium">{step.subtitle}</span>
                  ...
                  <div className="relative z-10 w-16 h-16 rounded-full bg-gradient-to-br from-navy to-[#2a5aa8] flex items-center justify-center shadow-lg flex-shrink-0">
      ...
      <section className="py-24 bg-navy relative overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center mb-16">
            <span className="inline-block px-4 py-1 bg-white/10 text-gold text-sm tracking-wider uppercase rounded-full mb-6">
              Bønnerne
            </span>
      ...
      <section className="py-20 bg-gradient-to-b from-white to-[#fdfbf7]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <Link
            href="/#mass-times"
            className="inline-flex items-center gap-3 px-8 py-4 bg-navy text-white rounded-lg font-medium hover:bg-[#2a5aa8] transition-colors shadow-lg shadow-navy/20"
          >
