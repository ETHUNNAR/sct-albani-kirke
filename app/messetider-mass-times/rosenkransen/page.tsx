      ...
      <section className="relative min-h-[70vh] w-full overflow-hidden">
        ...
        <div className="absolute inset-0 z-[1] overflow-hidden pointer-events-none">
          {[...Array(12)].map((_, i) => (
            <div
              key={i}
              className="absolute w-3 h-3 rounded-full bg-[#c5a059]/20 animate-pulse"
              style={{
                top: `${15 + (i * 7) % 70}%`,
                left: `${5 + (i * 8) % 90}%`,
        ...
        <div className="relative z-10 h-full flex flex-col items-center justify-center text-center px-4 py-32 max-w-5xl mx-auto">
          <div className="mb-8 relative">
            <div className="w-20 h-20 rounded-full border-2 border-[#c5a059]/50 flex items-center justify-center">
              <div className="w-12 h-12 rounded-full border border-[#c5a059] flex items-center justify-center">
                <svg className="w-6 h-6 text-[#c5a059]" fill="currentColor" viewBox="0 0 24 24">
                  <circle cx="12" cy="12" r="3" />
                </svg>
              </div>
            </div>
            <div className="absolute -top-1 left-1/2 -translate-x-1/2 w-2 h-2 rounded-full bg-[#c5a059]" />
            <div className="absolute -bottom-1 left-1/2 -translate-x-1/2 w-2 h-2 rounded-full bg-[#c5a059]" />
            <div className="absolute top-1/2 -left-1 -translate-y-1/2 w-2 h-2 rounded-full bg-[#c5a059]" />
            <div className="absolute top-1/2 -right-1 -translate-y-1/2 w-2 h-2 rounded-full bg-[#c5a059]" />
          </div>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="prose prose-lg max-w-none">
            <p className="text-slate-700 text-lg leading-relaxed mb-6">
              ...
              beder Maria om at gå i forbøn for os. Dog er rosenkransen <em className="text-[#1e3a8a] font-medium">en
            ...
            <p className="text-slate-700 text-lg leading-relaxed mb-6">
              ...
              bygger på englens hilsen til Maria ved bebudelsen. <em className="text-[#1e3a8a] font-medium">Inkarnationen
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="grid md:grid-cols-2 gap-16 items-center">
            <div className="relative">
              <div className="absolute left-8 top-0 bottom-0 w-px bg-gradient-to-b from-[#c5a059] via-[#1e3a8a] to-[#c5a059]" />

              <div className="space-y-12">
                <div className="relative pl-20">
                  <div className="absolute left-6 top-1 w-5 h-5 rounded-full bg-[#c5a059] border-4 border-white shadow-lg" />
                  <span className="text-[#c5a059] text-sm font-medium uppercase tracking-wider">1300-tallet</span>
                  <h3 className="font-serif text-xl font-bold text-[#1e3a8a] mt-1 mb-2">Tidlig form</h3>
                  <p className="text-slate-600">Rosenkransen opstod i sin enkle form som en meditativ bøn.</p>
                </div>

                <div className="relative pl-20">
                  <div className="absolute left-6 top-1 w-5 h-5 rounded-full bg-[#1e3a8a] border-4 border-white shadow-lg" />
                  <span className="text-[#1e3a8a] text-sm font-medium uppercase tracking-wider">Gennem århundrederne</span>
                  <h3 className="font-serif text-xl font-bold text-[#1e3a8a] mt-1 mb-2">Udvikling</h3>
                  <p className="text-slate-600">Rosenkransen udviklede sig over flere århundreder.</p>
                </div>

                <div className="relative pl-20">
                  <div className="absolute left-6 top-1 w-5 h-5 rounded-full bg-[#c5a059] border-4 border-white shadow-lg" />
                  <span className="text-[#c5a059] text-sm font-medium uppercase tracking-wider">1600-tallet</span>
                  <h3 className="font-serif text-xl font-bold text-[#1e3a8a] mt-1 mb-2">Nuværende form</h3>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Link
              ...
              className="inline-flex items-center justify-center gap-3 px-8 py-4 bg-white text-[#1e3a8a] rounded-lg font-medium hover:bg-slate-50 transition-colors border border-slate-200"
            >
