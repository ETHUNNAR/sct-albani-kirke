...
export default async function DukPage() {
  ...
  const pageData = dukPage || {
    ...
    description: [
      {
        _type: 'block',
        children: [{ _type: 'span', text: 'At styrke fællesskab med Gud og med hinanden - det er kernen i Sct. Albani DUK.' }],
      },
    ],
    membershipFee: '100 kr. pr. år',
    registrationUrl: 'https://www.duk.dk',
    ageGroups: [
      { name: 'Ministranter', ageRange: '1. kommunion - 18 år', description: 'For dem der ønsker at tjene ved alteret og deltage i kirkens liturgi.' },
      { name: 'Unge', ageRange: '18-30 år', description: 'Fællesskab for unge voksne der ønsker at styrke deres tro sammen.' },
    ],
    boardMembers: [
    ...
    socialMedia: { facebook: 'https://www.facebook.com/sctalbaniduk', instagram: 'https://www.instagram.com/sctalbaniduk' },
          ...
          {(pageData.membershipFee || pageData.registrationUrl) && (
            <div className="mt-12 bg-cream rounded-xl p-8 border-l-4 border-gold">
              ...
              {pageData.registrationUrl && (
                <a href={pageData.registrationUrl} target="_blank" rel="noopener noreferrer">
            ...
            <div className="text-center mb-16">
              ...
              {pageData.ageGroupsDescription && (
                <div className="max-w-4xl mx-auto mt-6">
                  <p className="text-lg text-slate-600 leading-relaxed">{pageData.ageGroupsDescription}</p>
                </div>
              )}
            </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div className="text-center mb-16">
              ...
              {pageData.boardDescription && (
                <div className="max-w-4xl mx-auto mt-6">
                  <p className="text-lg text-slate-600 leading-relaxed">{pageData.boardDescription}</p>
                </div>
              )}
            </div>
            ...
            {pageData.boardPhoto && (
              <div className="mb-12 rounded-xl overflow-hidden shadow-lg max-w-4xl mx-auto">
                <img src={urlFor(pageData.boardPhoto).width(1200).height(600).url()} alt="Bestyrelsen" className="w-full h-auto" />
              </div>
            )}
            ...
            <div className="border-t border-white/20 pt-8">
              ...
              <div className="flex justify-center gap-6">
                {pageData.socialMedia.facebook && (
                  <a href={pageData.socialMedia.facebook} target="_blank" rel="noopener noreferrer" className="bg-white/10 hover:bg-white/20 rounded-full p-4 transition-colors" aria-label="Facebook">
                ...
                {pageData.socialMedia.instagram && (
                  <a href={pageData.socialMedia.instagram} target="_blank" rel="noopener noreferrer" className="bg-white/10 hover:bg-white/20 rounded-full p-4 transition-colors" aria-label="Instagram">
                    <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
