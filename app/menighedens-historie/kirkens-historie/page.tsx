...
export default function KirkensHistorie() {
  const timeline = [
    {
      year: '1867',
      title: 'Missionsstationen grundlægges',
      description: 'Danmarks tredje katolske missionsstation etableres i Odense med 19 menighedsmedlemmer (12 voksne og 7 børn).',
      icon: Users,
      highlight: true
    },
    {
      year: '1869',
      title: 'Køb af ejendom',
      description: 'Ejendom købes til kirkebygning - tidligere ejet af den sidste katolske biskop i Odense.',
      icon: Landmark
    },
    {
      year: '1870',
      title: 'Sct. Mariæ Kirke indvies',
      description: '"Sct. Mariæ Kirke" indvies i bindingsværksbygninger med plads til cirka 200 tilhørere.',
      icon: Church
    },
    {
      year: '1899',
      title: 'Redemptoristerne ankommer',
      description: 'Redemptorister fra Østrig ankommer og iværksætter indsamlinger i Østrig og andre nationer til en ny kirkebygning.',
      icon: Sparkles
    },
    {
      year: '1906',
      title: 'Dalum Kloster og grundstensnedlæggelse',
      description: 'Sankt Hedvigs Søstre etablerer Dalum Kloster. Grundstensnedlæggelse for den nye "Sct. Albani Kirke".',
      icon: Landmark,
      highlight: true
    },
    {
      year: '1908',
      title: 'Den nye kirke indvies',
      description: 'Ny kirke indvies af biskop von Euch den 25. oktober, dedikeret til Vor Frue, Sankt Alban og Sankt Knud. Kirken er bygget i tidlig gotisk stil med romansk portal. Det 54 meter høje tårn indeholder fire klokker fra Tyskland.',
      icon: Church,
      highlight: true
    },
    {
      year: '1920',
      title: 'Orgel installeres',
      description: 'Orgel bygget af det tjekkiske firma Rieger installeres med 19 stemmer. Kirken rummer også træudskæringer fra Sydtyrol og glasmalerier fra Tyskland.',
      icon: Bell
    },
    {
      year: 'Efter 1980',
      title: 'Betydelig vækst',
      description: 'Menigheden ekspanderede markant, især efter 1980 med vietnamesisk immigration.',
      icon: Sparkles
    },
    {
      year: '2000',
      title: 'Over 2.200 medlemmer',
      description: 'Menigheden havde cirka 2.200 medlemmer omkring årtusindeskiftet.',
      icon: Users,
      highlight: true
    }
  ];
  ...
  const interiorElements = [
    {
      title: 'Altertavle',
      description: 'Maleri der forestiller Marias kroning'
    },
    {
      title: 'Jesu Hellige Hjerte',
      description: 'Statue af Jesu Hellige Hjerte'
    },
    {
      title: 'Døbefont',
      description: 'Døbefont med latinsk indskrift'
    },
    {
      title: 'Prædikestol',
      description: 'Dekoreret med fremstillinger af de fire kirkefædre'
    }
  ];
      ...
      <section className="relative bg-gradient-to-b from-[#1e3a8a] via-[#1e3a8a] to-[#2d4a9a] text-white overflow-hidden">
        <div className="absolute inset-0 opacity-10">
          <div className="absolute inset-0" style={{
            backgroundImage: `linear-gradient(30deg, transparent 0%, transparent 48%, rgba(255,255,255,0.1) 48%, rgba(255,255,255,0.1) 52%, transparent 52%, transparent 100%),
                             linear-gradient(150deg, transparent 0%, transparent 48%, rgba(255,255,255,0.1) 48%, rgba(255,255,255,0.1) 52%, transparent 52%, transparent 100%)`,
        ...
        <div className="relative max-w-5xl mx-auto px-6 py-24 md:py-32 text-center">
          ...
          <div className="mt-12 flex justify-center gap-8">
            <div className="text-center">
              <div className="text-4xl font-bold text-[#c5a059] mb-2">150+</div>
              <div className="text-sm text-white/80 uppercase tracking-wide">År med tradition</div>
            </div>
            <div className="w-px bg-white/20" />
            <div className="text-center">
              <div className="text-4xl font-bold text-[#c5a059] mb-2">2,200+</div>
              <div className="text-sm text-white/80 uppercase tracking-wide">Medlemmer i 2000</div>
            </div>
          </div>
        </div>
      ...
      <div className="max-w-5xl mx-auto px-6 py-20">
        <div className="mb-20 text-center max-w-3xl mx-auto">
          ...
          <h2 className="font-serif text-4xl md:text-5xl font-bold text-[#1e3a8a] mb-6">
            En kirke med rødder og vinger
          </h2>

          <p className="text-lg text-slate-700 leading-relaxed">
            Sct. Albani Kirke har gennem over 150 år været et åndeligt hjem for katolikker i Odense og på Fyn.
            Kirkens historie er en historie om tro, fællesskab og vedholdenhed.
          </p>
        </div>
          ...
          <div className="bg-white rounded-2xl border-2 border-slate-200 p-8 md:p-10 shadow-lg relative overflow-hidden group hover:border-[#c5a059] transition-colors duration-300">
            ...
            <div className="relative">
              ...
              <p className="text-slate-700 leading-relaxed mb-4">
                Kirken er bygget i tidlig gotisk stil med romansk portal. Det 54 meter høje tårn indeholder fire klokker fra Tyskland.
              </p>

              <p className="text-slate-700 leading-relaxed">
                Træudskæringer kommer fra Sydtyrol, og de smukke glasmalerier er fremstillet i Tyskland.
              </p>
            </div>
          </div>
        ...
        <div className="mt-16 bg-white rounded-2xl border-2 border-slate-200 p-8 md:p-12 relative overflow-hidden">
          ...
          <div className="relative">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <h3 className="font-serif text-3xl md:text-4xl font-bold text-[#1e3a8a] mb-6">
                En levende tradition
              </h3>

              <p className="text-lg text-slate-700 leading-relaxed mb-6">
                Historien om Sct. Albani Kirke er ikke blot fortid, den skrives hver dag gennem vores fælles gudstjenester,
                aktiviteter og det levende fællesskab, som udspringer af troen.
              </p>
