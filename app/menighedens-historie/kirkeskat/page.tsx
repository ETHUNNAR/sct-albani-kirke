...
export default function Kirkeskat() {
  const keyPoints = [
    {
      icon: AlertCircle,
      title: 'Katolikker er fritaget',
      description: 'Medlemmer af folkekirken skal betale kirkeskat til deres menighed, men katolikker i Danmark er fritaget for at betale kirkeskat til folkekirken gennem skattesystemet.',
      highlight: true
    },
    {
      icon: Info,
      title: 'Ingen statsstøtte',
      description: 'Den katolske kirke modtager ingen offentlig støtte. Kirken er helt afhængig af sine medlemmers frivillige bidrag.',
      highlight: true
    },
    {
      icon: Heart,
      title: 'Forpligtelse at støtte',
      description: 'Da det er en forpligtelse for katolske troende at understøtte sin kirke økonomisk, opfordres alle medlemmer til at tilmelde sig frivillig kirkeskat til den katolske kirke.',
      highlight: false
    }
  ];
      ...
      <div className="max-w-6xl mx-auto px-6 py-20">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-slate-600 max-w-3xl mx-auto">
            Forstå den katolske kirkes særlige situation i Danmark
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-20">
          {keyPoints.map((point, index) => {
            ...
            return (
              <div
                key={index}
                className={`group bg-white rounded-2xl border-2 ${point.highlight ? 'border-[#c5a059]' : 'border-slate-200'} p-8 hover:border-[#c5a059] transition-all duration-300 hover:shadow-xl relative overflow-hidden`}
              >
                <div className="absolute top-0 right-0 w-20 h-20 bg-gradient-to-br from-[#1e3a8a]/5 to-transparent rounded-bl-full" />

                <div className="relative">
                  <div className={`w-16 h-16 ${point.highlight ? 'bg-gradient-to-br from-[#c5a059] to-[#d4b06a]' : 'bg-gradient-to-br from-[#1e3a8a] to-[#2d4a9a]'} rounded-xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300`}>
        ...
        <div className="bg-white rounded-2xl border-2 border-slate-200 p-8 md:p-12 mb-16 relative overflow-hidden">
          ...
          <div className="relative max-w-4xl mx-auto">
            <div className="text-center mb-8">
              ...
              <h3 className="font-serif text-3xl md:text-4xl font-bold text-[#1e3a8a] mb-4">
          ...
          <div className="bg-gradient-to-br from-[#1e3a8a] to-[#2d4a9a] rounded-2xl p-8 md:p-10 text-white relative overflow-hidden">
            ...
            <div className="relative">
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-start gap-3">
                  <CheckCircle2 className="text-[#c5a059] flex-shrink-0 mt-1" size={20} />
                  <a href="https://www.katolsk.dk/kirkeskat" target="_blank" rel="noopener noreferrer" className="text-white/90 hover:text-white underline hover:no-underline transition-all">Udfyld formular på katolsk.dk</a>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="bg-white rounded-2xl border-2 border-slate-200 p-8 md:p-10 shadow-lg">
          <div className="text-center mb-8">
            ...
            <p className="text-slate-600">For mere information om kirkeskat og tilmelding</p>
          </div>
