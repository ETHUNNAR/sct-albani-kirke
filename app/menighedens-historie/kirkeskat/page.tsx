      ...
      <section className="bg-white border-b border-slate-200">
        <div className="max-w-6xl mx-auto px-6 py-16 md:py-24">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              <div className="inline-flex items-center gap-2 px-4 py-2 bg-gold/10 rounded-lg mb-6 border-l-4 border-gold">
                <Coins className="text-gold" size={20} />
                <span className="text-sm font-bold text-navy uppercase tracking-wider">Frivillig støtte</span>
              </div>
              <h1 className="font-serif text-5xl md:text-6xl font-bold text-navy mb-6 leading-tight">Kirkeskat</h1>
              <p className="text-xl text-slate-700 leading-relaxed mb-6">
                For den katolske kirke i Danmark er kirkeskat en frivillig ordning, da kirken ikke modtager offentlig støtte.
              </p>
              <div className="flex items-start gap-3 p-4 bg-cream rounded-xl border-l-4 border-navy">
                <Info className="text-navy flex-shrink-0 mt-0.5" size={20} />
            ...
            <div className="relative">
              <div className="absolute inset-0 bg-gradient-to-br from-gold/10 to-navy/10 rounded-3xl transform rotate-6" />
              <div className="relative bg-gradient-to-br from-navy to-[#2d4a9a] rounded-3xl p-10 text-white shadow-2xl">
                ...
                <div className="relative">
                  ...
                  <div className="inline-block px-6 py-3 bg-gold rounded-lg">
      ...
      <div className="bg-cream w-full">
        <div className="max-w-6xl mx-auto px-6 py-20">
          <div className="text-center mb-16">
            <h2 className="font-serif text-4xl md:text-5xl font-bold text-navy mb-4">Vigtig information</h2>
          ...
          <div className="bg-white rounded-2xl border-2 border-slate-200 p-8 md:p-12 mb-16 relative overflow-hidden">
            ...
            <div className="relative max-w-4xl mx-auto">
              <div className="text-center mb-8">
                ...
                <h3 className="font-serif text-3xl md:text-4xl font-bold text-navy mb-4">Økonomiske udfordringer</h3>
              </div>
              ...
              <div className="bg-cream rounded-xl p-6 border-2 border-navy/10">
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-16">
            <div className="bg-gradient-to-br from-navy to-[#2d4a9a] rounded-2xl p-8 md:p-10 text-white relative overflow-hidden">
              <div className="absolute inset-0 opacity-10">
                <div className="absolute inset-0" style={{ backgroundImage: `radial-gradient(circle at 2px 2px, white 1px, transparent 0)`, backgroundSize: '24px 24px' }} />
              </div>
              <div className="relative">
                <Coins className="text-gold mb-6" size={40} />
            ...
            <div className="bg-white rounded-2xl border-2 border-slate-200 p-8 md:p-10 relative overflow-hidden">
              ...
              <div className="relative">
                <Heart className="text-gold mb-6" size={40} />
                <h3 className="font-serif text-3xl font-bold text-navy mb-4">Skattefradrag</h3>
