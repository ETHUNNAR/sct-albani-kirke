...
export default function RedemptoristOrden() {
  return (
    <Layout>
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-navy via-[#2d4a9a] to-navy text-white">
        ...
        <div className="relative max-w-6xl mx-auto px-6 py-24 md:py-32">
          <div className="flex items-center justify-center mb-8">
            ...
            <Cross className="mx-4 text-gold" size={24} />
            <div className="h-px w-16 bg-gold" />
          </div>
        ...
        <div className="absolute bottom-0 left-0 right-0 h-16 bg-cream" style={{ clipPath: 'ellipse(75% 100% at 50% 100%)' }} />
      </section>
        ...
        <div className="max-w-6xl mx-auto px-6 py-20">
          <div className="bg-white rounded-2xl shadow-xl p-8 md:p-12 mb-16 border border-slate-100 relative overflow-hidden">
            ...
            <div className="relative">
              <div className="inline-block mb-6">
                <div className="flex items-center gap-3 px-4 py-2 bg-navy/5 rounded-full border border-navy/10">
                  <Book className="text-navy" size={20} />
                  <span className="text-sm font-semibold text-navy uppercase tracking-wider">Om Ordenen</span>
                </div>
              </div>
              <h2 className="font-serif text-4xl md:text-5xl font-bold text-navy mb-6 leading-tight">Selskabet af den Allerhelligste Frelser</h2>
              <div className="prose prose-lg max-w-none">
                <p className="text-slate-700 leading-relaxed text-lg mb-4">
                  Redemptorist-ordenen blev grundlagt i 1732 af den napolitanske adelsmand <strong className="text-navy font-semibold">Alfonso M. de Liguori</strong> (1696-1787), en kommende biskop og helgen. Ordenens primære formål er <em>"at forkynde evangeliet for de mest forladte mennesker, især de fattige."</em>
                </p>
                <p className="text-slate-700 leading-relaxed text-lg mb-4">
                  <strong className="text-navy font-semibold">Klemens M. Hofbauer</strong> (1751-1820), ordenens anden store helgen, udvidede kongregationen ud over Italien gennem sit arbejde i Warszawa og Wien.
                </p>
                <p className="text-slate-700 leading-relaxed text-lg">
                  I dag arbejder cirka <strong className="text-navy font-semibold">5.000 redemptorister</strong> præster og lægbrødre, i over 100 lande verden over. Ordenens generalhoved­kvarter ligger i Rom.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-16">
            <div className="bg-white rounded-xl p-8 shadow-lg border border-slate-100 hover:shadow-xl transition-shadow duration-300">
              <div className="w-14 h-14 bg-gradient-to-br from-navy to-[#2d4a9a] rounded-full flex items-center justify-center mb-6">
                <Heart className="text-white" size={24} />
              </div>
              <h3 className="font-serif text-2xl font-bold text-navy mb-4">Mission</h3>
            ...
            <div className="bg-white rounded-xl p-8 shadow-lg border border-slate-100 hover:shadow-xl transition-shadow duration-300">
              <div className="w-14 h-14 bg-gradient-to-br from-gold to-[#d4b06a] rounded-full flex items-center justify-center mb-6">
                <Cross className="text-white" size={24} />
              </div>
              <h3 className="font-serif text-2xl font-bold text-navy mb-4">Motto</h3>
            ...
            <div className="bg-white rounded-xl p-8 shadow-lg border border-slate-100 hover:shadow-xl transition-shadow duration-300">
              ...
              <h3 className="font-serif text-2xl font-bold text-navy mb-4">Verdensomspændende</h3>
          ...
          <div className="grid md:grid-cols-5 gap-8 mb-16">
            <div className="md:col-span-2">
              <div className="sticky top-8">
                <span className="text-sm font-bold text-gold uppercase tracking-widest">Historie</span>
                <h2 className="font-serif text-4xl font-bold text-navy mb-4 leading-tight">Fra Italien til Danmark</h2>
                <div className="w-20 h-1 bg-gradient-to-r from-gold to-transparent" />
              </div>
            </div>
            ...
            <div className="md:col-span-3 space-y-8">
              {[
                ...
                <div key={index} className="relative pl-8 border-l-2 border-gold/30">
                  <div className="absolute -left-[9px] top-0 w-4 h-4 bg-gold rounded-full border-4 border-cream" />
                  <div className="mb-2">
                    <span className="inline-block px-3 py-1 bg-navy text-white text-sm font-bold rounded-full">{event.year}</span>
                  </div>
                  <h3 className="font-serif text-2xl font-bold text-navy mb-3">{event.title}</h3>
          ...
          <div className="bg-gradient-to-br from-navy to-[#2d4a9a] rounded-2xl p-8 md:p-12 text-white relative overflow-hidden shadow-2xl mb-16">
            <div className="absolute inset-0 opacity-10">
              <div className="absolute inset-0" style={{ backgroundImage: `radial-gradient(circle at 2px 2px, white 1px, transparent 0)`, backgroundSize: '32px 32px' }} />
            </div>
            <div className="relative">
              <div className="text-center mb-8">
                <span className="text-sm font-bold text-gold uppercase tracking-widest">I Danmark i dag</span>
              ...
              <div className="max-w-3xl mx-auto">
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 border border-white/20">
                    <h4 className="font-bold text-lg mb-2 text-gold">Wien-München provinsen</h4>
                    <p className="text-white/90 text-sm">Næstved og Odense menigheder</p>
                  </div>
                  <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 border border-white/20">
                    <h4 className="font-bold text-lg mb-2 text-gold">Warszawa provinsen</h4>
